...
INSERT INTO public.categories (name, slug, image) VALUES
    ('Women''s Fashion', 'womens-fashion', 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=600&q=80'),
    ('Men''s Fashion', 'mens-fashion', 'https://images.unsplash.com/photo-1617137968427-85924c800a22?w=600&q=80'),
    ('Baby''s Fashion', 'babys-fashion', 'https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?w=600&q=80'),
    ('Casual Wear', 'casual-wear', 'https://images.unsplash.com/photo-1525171254930-643fc658b64e?w=600&q=80'),
    ('Formal Wear', 'formal-wear', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80'),
    ('Accessories', 'accessories', 'https://images.unsplash.com/photo-1606760227091-3dd870d97f1d?w=600&q=80');

-- Insert default slider slides
INSERT INTO public.slider_slides (image, heading, text, cta_text, cta_link, sort_order) VALUES
    ('https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1920&q=80', 'New Season Collection', 'Discover the latest trends in fashion and clothing', 'Shop Now', '/shop', 1),
    ('https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1920&q=80', 'Summer Sale', 'Up to 50% off on selected clothing items', 'View Collection', '/shop?sale=true', 2),
    ('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1920&q=80', 'Premium Fashion', 'Handpicked clothing for every style and occasion', 'Explore', '/shop', 3);

-- Insert approved sample reviews
INSERT INTO public.reviews (name, rating, text, is_approved) VALUES
    ('Fatima Rahman', 5, 'The quality of the fabrics is outstanding! I ordered three dresses and each one fits perfectly. Will definitely shop again.', true),
    ('Arif Hossain', 5, 'Bought a formal shirt and chinos for my office. The fitting is excellent and the material feels premium. Highly recommended!', true),
    ('Nusrat Jahan', 4, 'Great variety of kids clothing. My daughter loves her new party frock! Fast delivery too.', true);
