...
export default function ShopPage() {
  ...
  return (
    <Layout>
      <PageBanner
        title="Shop"
        badge="Browse Our Collection"
        badgeIcon={ShoppingBag}
        description={isLoading ? 'Loading products...' : `${filteredProducts.length} products found`}
      />

      <div className="container-shop section-padding">        <div className="flex flex-col lg:flex-row gap-8">
          {/* Sidebar - Desktop */}
